...
module.exports = {
  ...
  Query: _objectSpread(_objectSpread({}, _resolver["default"].Query), _todo["default"].Query),
  Mutation: _objectSpread(_objectSpread({}, _resolver["default"].Mutation), _todo["default"].Mutation)
};